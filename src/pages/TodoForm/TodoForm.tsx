...
const TodoForm: React.FC = () => {
  ...
  const submit = (data: typeof defaultValues) => { console.log(data); };
      ...
      <BoxStyled>
        <FormStyled onSubmit={handleSubmit(submit)}>
          <InputBlock style={{ gridArea: 'title' }}>
            ...
            <InputStyled type="text" {...register('title', { required: true })} />
            <InputerrorStyled>{errors.title?.message}</InputerrorStyled>
          </InputBlock>
          ...
          <SubmitStyled style={{ gridArea: 'submit' }} type="submit" disabled={!isValid}> Submit </SubmitStyled>
        </FormStyled>
      </BoxStyled>
    </TodoFormWrapperStyled>
  );
